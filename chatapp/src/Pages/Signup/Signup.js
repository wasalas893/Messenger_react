...
export default class SignUp extends Component{
    ...
    async handleSubmit(event){
        ...
        try {
            ...
            document.getElementById('1').innerHTML="Error is signing up please try again"
        }
    }
    render(){
        const Signinsee={
                    ...
                    />
                     <div>
                        <p style={{color:'grey',fontSize:'15px'}}>
                            Please fill all fields and password should be greater then
                        </p>
                    </div>
                    <div className="CenterAliningItems">
                        <button class="customhandlefile" type="submit">
                            <span>Sign Up</span>
                        </button>
                    </div>
                    <div>
